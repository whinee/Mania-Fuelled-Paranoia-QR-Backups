...
\vspace{10pt}
\begin{tabular}{|Sc|>{\centering\arraybackslash}p{3.5em}|*{12}{>{\centering\arraybackslash}p{1em}|}>{\centering\arraybackslash}p{3em}|*{2}{>{\centering\arraybackslash}p{1em}|}}
\hline
...
\input{archive/qr/shift_jis_x_0208.tex}
